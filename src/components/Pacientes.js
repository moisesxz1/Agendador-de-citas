...
const Pacientes = ({citas}) => {
    ...
    // const arregloNuevo = [];
    // arregloNuevo.push(citas.pacientes[0]);
    // arregloNuevo.push(citas.pacientes[1]);
...
//En react se comienda utilizar map por encima de forReach para iterar estructuras
//Cuando se usa iteradores como map se recomienda agregar un key, de esa forma va a ser mas facil para react conocer los elementos y saber cuando algo cambia